...
namespace asynclib::details
{
  ...
  struct __async_task_base
    {

      _End end;
      using end_details = __async_function_end_details<_End>;

      inline constexpr __async_task_base (_End _end) noexcept: end (_end)
        { }
  ...
  struct __async_task_base<_End, void>
    {
  ...
  template<typename T>
  concept __async_task_target = __async_function_end<T (*) (GAsyncResult*, GError**)>;

  template<__async_function_begin _Begin,
           __async_function_end _End,
           typename Functor>
  struct __async_task: public __async_task_base<_End, typename __async_function_end_details<_End>::referrer_type>
    {

      Functor begin;
      using end_details = __async_function_end_details<_End>;

      inline constexpr __async_task (Functor&& _begin, _End _end) noexcept (std::is_nothrow_move_constructible_v<Functor>):
          __async_task_base<_End, typename end_details::referrer_type> (_end),
